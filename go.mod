...
replace (
	...
	// Thanos based on Prometheus 3.11
	// https://github.com/thanos-io/thanos/pull/8774
	github.com/thanos-io/thanos => github.com/ringerc/thanos-patches v0.0.0-20260421040247-5b067c41826f
)
