...
type StreamDescriptor struct {
	...
	ExternalLabels map[string]string      `protobuf:"bytes,1,rep,name=externalLabels,proto3" json:"externalLabels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *StreamDescriptor) GetExternalLabels() map[string]string {
	if x != nil {
...
const file_stream_proto_rawDesc = "" +
	"\n" +
	"\fstream.proto\x12\x06stream\"\xab\x01\n" +
	"\x10StreamDescriptor\x12T\n" +
	"\x0eexternalLabels\x18\x01 \x03(\v2,.stream.StreamDescriptor.ExternalLabelsEntryR\x0eexternalLabels\x1aA\n" +
	"\x13ExternalLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B<Z:github.com/thanos-io/thanos-parquet-gateway/proto/streampbb\x06proto3"
...
var file_stream_proto_goTypes = []any{
	(*StreamDescriptor)(nil), // 0: stream.StreamDescriptor
	nil,                      // 1: stream.StreamDescriptor.ExternalLabelsEntry
}
var file_stream_proto_depIdxs = []int32{
	1, // 0: stream.StreamDescriptor.externalLabels:type_name -> stream.StreamDescriptor.ExternalLabelsEntry
