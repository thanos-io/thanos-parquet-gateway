...
type Metadata struct {
	...
	SourceBlocks   []string               `protobuf:"bytes,6,rep,name=sourceBlocks,proto3" json:"sourceBlocks,omitempty"` // ULIDs of TSDB blocks used to create this parquet block
...
func (x *Metadata) GetSourceBlocks() []string {
	if x != nil {
...
const file_meta_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"meta.proto\x12\x04meta\"\xa6\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\fsourceBlocks\x18\x06 \x03(\tR\fsourceBlocks\x1aP\n" +
